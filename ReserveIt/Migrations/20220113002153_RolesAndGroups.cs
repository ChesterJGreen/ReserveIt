        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserGroupMapping_Groups_GroupId",
                        column: x => x.GroupId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupRoleMapping", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GroupRoleMapping_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GroupRoleMapping_Roles_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupRoleMapping_GroupId",
                table: "GroupRoleMapping",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupRoleMapping_RoleId",
                table: "GroupRoleMapping",
                column: "RoleId");
